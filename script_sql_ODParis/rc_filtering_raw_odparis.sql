...
| READ THIS |
 -----------
this function has some control to execute only part of the correction process, see CONTROL file.
...
BEGIN
	...
	IF(TRUE= deleting_table)
		...
		BEGIN --delete table arbres_remarquables if exists : this table contains only 60 trees, and the information is redundant with trees in 'arbres'
			EXECUTE 'DROP TABLE IF EXISTS ' || schema_name || '.arbres_remarquables ;' ; --delete the 'arbres_remarquables' table
